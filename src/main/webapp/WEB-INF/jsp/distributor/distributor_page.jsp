...
<body>
 ...
 <a href="${addURL }" class="button">Add distributor</a>
 ...
 <table width="100%" border="1">
  ...
  <c:forEach items="${listdistributor }" var="distributor" >
   <tr>
    ...
    <td>
     <spring:url value="/distributor/delete/${distributor.id }" var="deleteURL" />
     <a href="${deleteURL } class="button"">Delete</a>
    </td>
   </tr>    
  </c:forEach>
 </table>
...
<br>
<a href="/payment/add" class="button">Make Payment</a><br>
 <br>
<br>
